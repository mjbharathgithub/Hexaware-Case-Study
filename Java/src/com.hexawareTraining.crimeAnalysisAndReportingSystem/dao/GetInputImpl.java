...
//        Matcher matcher = pattern.matcher(dateString);
        ...
        if(!checkStatus(status)) {
        	throw new IllegalUserInputException(status+" is not accepted as Status for Incidents");
        }
...
//            System.out.println("You entered the date: " + startDate+" End dAte"+ endDate+" "+comparedResult);
	...
	public String searchIncidentsInput() {
		...
		case 4:
			...
			if(checkStatus(criteria)) return criteria;
...
//        String caseStatus=scanner.nextLine();
	...
	@Override
	public void updateCaseInput(Case case1) {
...
//		case_title = ?, case_description = ?, status = ?
		...
		System.out.println("Case is "+(processor.updateCaseDetails(case1)?"Updated":"Not Updated"));
	}
